export default {
  ...
  savedFile: {
    ...
    getFileInfo: `SELECT public."Saved_File"."FileID", public."File"."Name", public."File"."Size" 
  ...
  savedFolder: {
    ...
    getFolderInfo: `SELECT public."Saved_Folder"."FolderID", public."Folder"."Name", public."Folder"."Criteria" 
